...
status: beta
download_zip: https://github.com/jbox-web/redmine_git_hosting/archive/v1.0.0-beta.zip
download_tar: https://github.com/jbox-web/redmine_git_hosting/archive/v1.0.0-beta.tar.gz
---
...
* mirror repository URLs should permit dots in repository path
