module RedmineGitolite
  ...
  module Config
    ...
    def self.gitolite_use_sidekiq?
      if !Setting.plugin_redmine_git_hosting.nil? and !Setting.plugin_redmine_git_hosting[:gitolite_use_sidekiq].nil?
        if Setting.plugin_redmine_git_hosting[:gitolite_use_sidekiq] == 'true'
          return true
        else
          return false
        end
