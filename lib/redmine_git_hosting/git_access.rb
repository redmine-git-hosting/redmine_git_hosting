...
module RedmineGitHosting
  class GitAccess
    ...
    def download_access_check(actor, repository, ssl: false)
      # First check that SmartHTTP is enabled for repository
      return smart_http_is_disabled! repository unless smart_http_enabled_for_download? repository, ssl: ssl
    ...
    def smart_http_enabled_for_download?(repository, ssl: false)
      ...
      return false if repository.only_http_access_enabled? && ssl
