class MigrateParameters < ActiveRecord::Migration
  def self.up
    ...
    new_setting[:ssh_server_domain]     = RedmineGitolite::GitoliteWrapper.my_root_url
    new_setting[:http_server_domain]    = RedmineGitolite::GitoliteWrapper.my_root_url
    ...
    puts YAML::dump(Setting.plugin_redmine_git_hosting)
  end
