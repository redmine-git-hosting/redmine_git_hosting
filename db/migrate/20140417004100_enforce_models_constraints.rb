class EnforceModelsConstraints < ActiveRecord::Migration
  ...
  def self.up
    ...
    change_column :gitolite_public_keys, :active,     :integer, :default => 1
    ...
    change_column :repository_deployment_credentials, :active, :integer, :default => 1
    ...
    change_column :repository_mirrors, :active,        :integer, :default => 1
    ...
    change_column :repository_post_receive_urls, :active,        :integer, :default => 1
