class RepositoryGitExtra < ActiveRecord::Base
  ...
  def setup_defaults
    write_attribute(:git_http,   RedmineGitolite::Config.gitolite_http_by_default)       if RedmineGitolite::Config.gitolite_http_by_default
    write_attribute(:git_daemon, RedmineGitolite::Config.gitolite_daemon_by_default)     if RedmineGitolite::Config.gitolite_daemon_by_default
    write_attribute(:git_notify, RedmineGitolite::Config.gitolite_notify_by_default)     if RedmineGitolite::Config.gitolite_notify_by_default
  end
