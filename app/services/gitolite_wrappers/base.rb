module GitoliteWrappers
  class Base
    ...
    class << self
      ...
      def wrappers
        load_klasses! if descendants.empty?
        @wrappers ||= {}
      end


      # Require GitoliteWrappers classes to trigger **inherited** method.
      # See: https://github.com/rails/rails/issues/3364#issuecomment-7996376
      #
      def load_klasses!
        Dir[RedmineGitHosting.plugin_app_dir('services', 'gitolite_wrappers', '**', '*.rb')].each do |file|
