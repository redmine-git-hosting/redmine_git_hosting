class GitNotifier
  ...
  private
    ...
    def filter_list(merged_map)
      ...
      exclude_list = RedmineGitolite::Config.get_setting(:gitolite_notify_global_exclude) unless RedmineGitolite::Config.get_setting(:gitolite_notify_global_exclude).empty?
